...
public class ItemController {
	...
	@GetMapping("/search")
	public ResponseEntity<Page<ItemDataTransferObject>> search(
		@Valid @RequestBody ItemSearchCriteria searchBody
	){
		return ResponseEntity.ok(
			itemService.search(searchBody).map(itemMapper::toDto)
		);
	}
